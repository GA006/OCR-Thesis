    ...
    if schema==0:
        ...
        categories = \
            [{"supercategory": "layout", "id": 0, "name": "Background"},
             ...
             {"supercategory": "layout", "id": 2, "name": "Heading"},
             {"supercategory": "layout", "id": 3, "name": "Outlines"},
             {"supercategory": "layout", "id": 4, "name": "OtherText"},
             {"supercategory": "layout", "id": 5, "name": "ImageRegion"},
             {"supercategory": "layout", "id": 6, "name": "TableRegion"},
             {"supercategory": "layout", "id": 7, "name": "MathsRegion"},
             {"supercategory": "layout", "id": 8, "name": "SeparatorRegion"},
             {"supercategory": "layout", "id": 9, "name": "OtherRegion"},
             {"supercategory": "layout", "id": 10, "name": 'DropCapital'}]
        ...
        conversion = \
            {
                ...
                'heading':          find_categories("Heading"),
                'header':           find_categories("Outlines"),
                'footer':           find_categories("Outlines"),
                'page-number':      find_categories("Outlines"),
                'floating':         find_categories("OtherText"),
                'credit':           find_categories("Outlines"),
                'caption':          find_categories("OtherText"),
                'drop-capital':     find_categories("DropCapital"),
